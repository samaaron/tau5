defmodule Tau5Web.Plugs.TidewaveLogger do
  ...
  defmodule CachedBodyAdapter do
    ...
    if Version.compare(@plug_version, "1.15.0") == :gt do
      require Logger
      Logger.warning("TidewaveLogger: Plug version #{@plug_version} may not be compatible with CachedBodyAdapter. Please test thoroughly.")
    end
  ...
  defp log_tool_call(%{method: method} = request_info, conn, duration) do
    ...
    result = case {status, response} do
