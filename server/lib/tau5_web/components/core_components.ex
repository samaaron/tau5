defmodule Tau5Web.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: Tau5Web.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Tau5Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Tau5Web.Gettext, "errors", msg, opts)
    end
  end
